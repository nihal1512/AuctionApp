  ...
  InputDecoration get decoration => InputDecoration(
        ...
        border: OutlineInputBorder(
          ...
          borderSide: BorderSide(
            color:  Color(0xffffffff), // Change this to your desired border color
            width: 2,
          ),
        ),
        ...
        errorBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12.h),
          borderSide: BorderSide(
            color:  Colors.white,// Change this to your desired error border color
            width: 2,
          ),
        ),
        focusedErrorBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12.h),
          borderSide: BorderSide(
            color: Colors.red, // Change this to your desired focused error border color
            width: 2,
          ),
        ),
